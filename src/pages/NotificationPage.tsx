...
export default function NotificationPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col rounded-2xl border border-[#E5E5E5] bg-white shadow-sm dark:border-[#2F2F2F] dark:bg-[#111111]">
      ...
      <ul className="flex max-h-[365px] flex-col gap-3 overflow-y-auto px-5 pb-5 sm:px-6 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 m-0 list-none p-0">
