  ...
  return (
    <div className="min-h-svh flex flex-col items-center justify-center bg-secondary-50 dark:bg-[#262626] px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col gap-6 w-full max-w-sm md:max-w-4xl">
        <div
          id="card"
          className="bg-secondary-0 dark:bg-[#262626] grid grid-cols-1 md:grid-cols-2 p-0 shadow-sm rounded-xl border border-[#E5E5E5] dark:border-[#2e2e2e] overflow-hidden"
        >
          <form
        ...
        <p className="text-center text-sm text-secondary-500 mt-2 text-[#737373] dark:text-[#A3A3A3] px-6 leading-relaxed">
          By clicking continue, you agree to our{" "}
          <a className="underline underline-offset-4 dark:hover:text-white">
            Terms of Service
          </a>{" "}
          and{" "}
          <a className="underline underline-offset-4 dark:hover:text-white">
