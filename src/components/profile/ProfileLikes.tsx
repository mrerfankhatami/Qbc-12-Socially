...
export default function ProfileLikes() {
  ...
  return (
    <div className="flex flex-col">
      <div className="w-[calc(100%-2rem)] max-w-250 mt-4 mx-auto bg-[#0A0A0A] rounded-lg p-3 dark:bg-[#f5f5f5]">
      ...
      <div className="border-2 flex flex-col gap-4 border-[#E5E5E5] dark:border-[#262626] rounded-xl w-[calc(100%-2rem)] max-w-250 mt-4 p-6 mx-auto">
